...
if ( ! class_exists( 'PeliculaCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class PeliculaCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'pelicula_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	PeliculaCoreDashboardRestAPI::get_instance();
}
