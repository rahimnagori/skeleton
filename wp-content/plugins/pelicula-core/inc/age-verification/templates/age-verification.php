<div id="qodef-age-verification-modal" class="qodef-m <?php echo esc_attr( $holder_classes ); ?>" <?php qode_framework_inline_style( $content_style ); ?>>
	...
	<div class="qodef-m-content">
		...
		<?php if ( ! empty( $subtitle ) ): ?>
			<p class="qodef-m-content-subtitle"><?php echo wp_kses_post( $subtitle ); ?></p>
		<?php endif; ?>
		
		<?php if ( ! empty( $note ) ): ?>
			<p class="qodef-m-content-note"><?php echo wp_kses_post( $note ); ?></p>
		<?php endif; ?>
		<?php if ( class_exists( 'PeliculaCoreButtonShortcode' ) ) { ?>
			<div class="qodef-m-content-prevent">
				<?php
				$button_params = array(
					'link'          => '#',
					'text'          => esc_html__( 'Yes I am', 'pelicula-core' ),
					'size'          => 'normal',
				...
				$button_params = array(
					...
					'text'          => esc_html__( 'No I am not', 'pelicula-core' ),
					'size'          => 'normal',
