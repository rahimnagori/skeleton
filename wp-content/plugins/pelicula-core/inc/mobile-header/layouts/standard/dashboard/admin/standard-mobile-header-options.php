...
if ( ! function_exists( 'pelicula_core_add_standard_mobile_header_options' ) ) {
	function pelicula_core_add_standard_mobile_header_options( $page ) {
		
		$section = $page->add_section_element(
			array(
				'name'       => 'qodef_standard_mobile_header_section',
				'title'      => esc_html__( 'Standard Mobile Header', 'pelicula-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'pelicula_core_action_after_mobile_header_options_map', 'pelicula_core_add_standard_mobile_header_options' );
}