...
if ( ! function_exists( 'pelicula_core_fullscreen_menu_typography_options' ) ) {
	function pelicula_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'pelicula-core' )
				)
			);
	...
	add_action( 'pelicula_core_action_after_fullscreen_menu_options_map', 'pelicula_core_fullscreen_menu_typography_options', 15 );
}