...
class PeliculaCoreElementorCountdown extends \Elementor\Widget_Base{
	...
	public function set_object(){
			$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('pelicula_core_countdown');
	}
...
pelicula_core_get_elementor_widgets_manager()->register( new PeliculaCoreElementorCountdown() );
