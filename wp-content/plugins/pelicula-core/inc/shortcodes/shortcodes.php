...
if ( ! class_exists( 'PeliculaCoreShortcodes' ) ) {
	class PeliculaCoreShortcodes {
		...
		function init() {
			...
			include_once PELICULA_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once PELICULA_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once PELICULA_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'pelicula_core_filter_register_shortcodes', $shortcodes = array() );
	...
	PeliculaCoreShortcodes::get_instance();
}