...
if ( ! function_exists( 'pelicula_core_add_banner_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pelicula_core_add_banner_shortcode( $shortcodes ) {
		$shortcodes[] = 'PeliculaCoreBannerShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'pelicula_core_filter_register_shortcodes', 'pelicula_core_add_banner_shortcode' );
}

if ( class_exists( 'PeliculaCoreShortcode' ) ) {
	class PeliculaCoreBannerShortcode extends PeliculaCoreShortcode {
		
		public function __construct() {
			$this->set_layouts( apply_filters( 'pelicula_core_filter_banner_layouts', array() ) );
			$this->set_extra_options( apply_filters( 'pelicula_core_filter_banner_extra_options', array() ) );
			
			parent::__construct();
		}
		
		public function map_shortcode() {
			$this->set_shortcode_path( PELICULA_CORE_SHORTCODES_URL_PATH . '/banner' );
			$this->set_base( 'pelicula_core_banner' );
			$this->set_name( esc_html__( 'Banner', 'pelicula-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds banner element', 'pelicula-core' ) );
		...
		public function render( $options, $content = null ) {
			...
			return pelicula_core_get_template_part( 'shortcodes/banner', 'variations/' . $atts['layout'] . '/templates/' . $atts['layout'], '', $atts );
		}
