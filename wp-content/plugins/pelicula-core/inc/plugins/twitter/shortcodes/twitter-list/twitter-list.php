...
if ( ! function_exists( 'pelicula_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function pelicula_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'PeliculaCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'pelicula_core_filter_register_shortcodes', 'pelicula_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'PeliculaCoreListShortcode' ) ) {
	class PeliculaCoreTwitterListShortcode extends PeliculaCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( PELICULA_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'pelicula_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'pelicula-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'pelicula-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'pelicula-core' ),
				'group'      => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'pelicula-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'pelicula-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'pelicula-core' ),
				'options'       => pelicula_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'pelicula-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return pelicula_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
