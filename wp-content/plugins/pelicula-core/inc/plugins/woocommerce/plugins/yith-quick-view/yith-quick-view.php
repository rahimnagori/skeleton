...
if ( ! class_exists( 'PeliculaCoreWooCommerceYITHQuickView' ) ) {
	class PeliculaCoreWooCommerceYITHQuickView {
		...
		function change_templates_position() {
			...
			add_action( 'pelicula_core_action_product_list_item_additional_image_content', array( YITH_WCQV_Frontend(), 'yith_add_quick_view_button' ) );
		}
	...
	PeliculaCoreWooCommerceYITHQuickView::get_instance();
}