...
if ( ! function_exists( 'pelicula_core_add_vertical_header_options' ) ) {
	function pelicula_core_add_vertical_header_options( $page, $general_header_tab ) {
	...
	add_action( 'pelicula_core_action_after_header_options_map', 'pelicula_core_add_vertical_header_options', 10, 2 );
}