...
if ( ! function_exists( 'pelicula_core_add_team_single_sidebar_meta_boxes' ) ) {
	/**
	 * Function that add sidebar meta boxes for team single module
	 */
	function pelicula_core_add_team_single_sidebar_meta_boxes( $page, $has_single ) {
	...
	add_action( 'pelicula_core_action_after_team_meta_box_map', 'pelicula_core_add_team_single_sidebar_meta_boxes', 10, 2 );
}