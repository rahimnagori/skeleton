...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php echo pelicula_core_get_portfolio_link(); ?>" target="<?php echo pelicula_core_get_portfolio_link_target(); ?>">
			<?php echo pelicula_core_get_list_shortcode_item_image( $image_dimension, $portfolio_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>