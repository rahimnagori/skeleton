...
if ( ! function_exists( 'pelicula_core_add_font_awesome_to_collection' ) ) {
	function pelicula_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'PeliculaCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'pelicula_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PeliculaCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return PELICULA_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( PELICULA_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( PELICULA_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
