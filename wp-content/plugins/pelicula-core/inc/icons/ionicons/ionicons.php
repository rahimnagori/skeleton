...
if ( ! function_exists( 'pelicula_core_add_ionicons_to_collection' ) ) {
	function pelicula_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'PeliculaCoreIonIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'pelicula_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PeliculaCoreIonIconsPack extends QodeFrameworkIconPack {
