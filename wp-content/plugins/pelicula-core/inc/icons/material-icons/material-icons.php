...
if ( ! function_exists( 'pelicula_core_add_material_icons_to_collection' ) ) {
	function pelicula_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'PeliculaCoreMaterialIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'pelicula_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PeliculaCoreMaterialIconsPack extends QodeFrameworkIconPack {
