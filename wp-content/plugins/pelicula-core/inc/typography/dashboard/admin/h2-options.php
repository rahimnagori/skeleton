...
if ( ! function_exists( 'pelicula_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function pelicula_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'pelicula-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'pelicula-core' )
				)
			);
	...
	add_action( 'pelicula_core_action_after_typography_options_map', 'pelicula_core_add_h2_typography_options' );
}