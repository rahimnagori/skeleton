...
if ( ! function_exists( 'pelicula_core_add_h5_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function pelicula_core_add_h5_typography_options( $page ) {
		...
		if ( $page ) {
			$h5_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h5',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H5 Typography', 'pelicula-core' ),
					'description' => esc_html__( 'Set values for Heading 5 HTML element', 'pelicula-core' )
				)
			);
	...
	add_action( 'pelicula_core_action_after_typography_options_map', 'pelicula_core_add_h5_typography_options' );
}